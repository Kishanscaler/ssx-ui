...
/**
 * Batch A samples. Only the batch A agent edits this file. See ./index.tsx.
 *
...
const samples: Samples = {
  ...
  IconButton: (ui) => (
    <>
      ...
      <ui.IconButton aria-label="Add module" size="sm" variant="secondary">
        {glyph}
      </ui.IconButton>
  ...
  Link: (ui) => (
    <>
      ...
      <ui.Link asChild>
        <a href="#apply">As child</a>
      </ui.Link>
    </>
  ),
  Text: (ui) => (
    <ui.Text tone="secondary" size="sm">
  ...
  Badge: (ui) => (
    <>
      ...
      <ui.Badge tone="highlight" size="lg">
        New
      </ui.Badge>
    </>
  ),
  StatusDot: (ui) => (
    <>
      <ui.StatusDot tone="success" />
      <ui.StatusDot tone="danger" size="lg" pulse />
    </>
  ),
  Avatar: (ui) => (
  ...
  Skeleton: (ui) => (
    <>
      <ui.Skeleton className="w-40" />
      <ui.Skeleton shape="circle" size="sm" />
    </>
  ),
  KbdGroup: (ui) => (
    <ui.KbdGroup>
  ...
  KbdMod: 'KbdGroup',
  Code: (ui) => <ui.Code tone="danger">solution.py</ui.Code>,
  CodeBlockGroup: (ui) => (
    <ui.CodeBlockGroup className="w-full">
      <ui.CodeBlockHeader>
        <span>bfs.py</span>
        <ui.CopyButton value="def bfs(): pass" aria-label="Copy bfs.py to the clipboard" />
      </ui.CodeBlockHeader>
      <ui.CodeBlock>
        <ui.CodeToken kind="keyword">def</ui.CodeToken> <ui.CodeToken kind="function">bfs</ui.CodeToken>
        {'(): pass'}
      </ui.CodeBlock>
    </ui.CodeBlockGroup>
  ),
