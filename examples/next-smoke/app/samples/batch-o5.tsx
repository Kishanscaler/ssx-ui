...
/**
 * Batch O5 (organisms O5) samples. Only the batch O5 agent edits this file. See ./index.tsx.
 * Rendered in a SERVER Component: DisplayBanner and its parts are server
 * components; the Button and the BannerCountdown they render are client
 * references given only serialisable props.
 */
