...
/**
 * Batch M6 (molecules M6) samples. Only the batch M6 agent edits this file. See ./index.tsx.
 * Everything here renders in a SERVER Component: Breadcrumbs is a server
 * component (its collapsed "…" is the client Menu); Pagination and
 * SelectableCard are client references, given only serialisable props.
 */
